    ...
    let flatTranscript = transcripts.map((transcript) => {
      const flattenEvaluation = (key) => {
        return Object.fromEntries(
          transcript[key].map((ev, index) => [`${key}${ev.key}`, ev.score]),
        );
      };
      ...
      flatObject['Điểm TB GVHD'] = transcript['Điểm TB GVHD'];
      flatObject['Điểm TB GVPB1'] = transcript['Điểm TB GVPB1'];
      flatObject['Điểm TB GVPB2'] = transcript['Điểm TB GVPB2'];

      flatObject['Điểm TB GVHĐ1'] = transcript['Điểm TB GVHĐ1'];
      flatObject['Điểm TB GVHĐ2'] = transcript['Điểm TB GVHĐ2'];
      flatObject['Điểm TB GVHĐ3'] = transcript['Điểm TB GVHĐ3'];
