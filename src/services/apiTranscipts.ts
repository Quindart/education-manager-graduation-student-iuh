...
//HEAD_LECTURER
export const getTranscriptsToExport = async (
  termId: string,
  type: string,
...
//LECTURER
export const getTranscriptsByTypeAssign = async (
  termId: string,
  type: string,
): Promise<ResponseType> => {
...
export const getTranscriptOfStudentInGroup: any = (
  termId: string,
  type: string,
  ...
  return axiosConfig.get(
    `${URL}?termId=${termId}&type=${typeSend}&groupStudentId=${groupStudentId}`,
  );
};

export const getTranscriptsByTypeEvaluation: any = (
  termId: string,
  type: string,
  studentId: string,
) => {
...
// }
export const getTranscriptByLecturerId: any = (
  termId: string,
  lecturerId: string,
  type: string,
) => {
