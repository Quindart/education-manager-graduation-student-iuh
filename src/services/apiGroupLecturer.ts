...
export const getGrLecturerByTypeEvaluationByLecturer: any = async (
  termId: string,
  type: string,
  lecturerId: string,
) => {
  return axiosConfig.get(
    `${URL}/evaluation-lecturer?termId=${termId}&type=${type}&lecturerId=${lecturerId}`,
  );
};
...
//[GET]
export const getGroupLecturerByLecturerId: any = async (
  termId: string,
  lecturerId: string,
  type: string,
) => {
...
//[UPDATE]
export const updateGroupLecturerTimeAndLocation: any = (
  id: string | number,
  data: { startDate: string; endDate: string; location: string },
) => {
...
//[CREATE]
export const createGroupLecturer: any = (
  type: string,
  data: { termId: string; lecturers: string[]; type: string; keywords?: string },
) => {
...
//[DELETE MEMBER]
export const removeMemberFromGroupLecturerById: any = (
  id: string,
  data: { lecturerId: string },
) => {
