        ...
        sections: [
            {
                ...
                children: [
                    ...
                    new Paragraph({
                        ...
                        children: [
                            new TextRun({
                                text: `      Mã SV 2:  ${students && students[0]?.username}                                          Họ tên sinh viên 2: ${students && students[1]?.fullName}`,
                                size: 24,
                            }),
                        ],
                    }),
                        ...
                        rows: [
                            ...
                            ...rows.map((row, index) => (
                                new TableRow({
                                    ...
                                    children: [
                                        new TableCell({ verticalAlign: VerticalAlign.CENTER, children: [new Paragraph({ alignment: 'center', children: [new TextRun({ text: (row?.evaluationKey), size: 23 })] })] }),
                                        new TableCell({ verticalAlign: VerticalAlign.CENTER, children: [new Paragraph({ children: [new TextRun({ text: row.evaluationName, size: 23 })] })] }),
                                        new TableCell({ verticalAlign: VerticalAlign.CENTER, children: [new Paragraph({ alignment: 'center', children: [new TextRun({ text: `${row?.scoreMax}`, size: 23 })] })] }),
                                        new TableCell({ verticalAlign: VerticalAlign.CENTER, children: [new Paragraph({ alignment: 'center', children: [new TextRun({ text: `${row[`student_${students[0].username}_score`]}`, size: 23 })] })] }),
                                        new TableCell({ verticalAlign: VerticalAlign.CENTER, children: [new Paragraph({ alignment: 'center', children: [new TextRun({ text: `${row[`student_${students[0].username}_score`]}`, size: 23 })] })] }),
                            ...
                            new TableRow({
                                ...
                                children: [
                                    ...
                                    new TableCell({
                                        ...
                                        verticalAlign: VerticalAlign.CENTER,
                                        children: [new Paragraph({ children: [new TextRun({ text: `${students[0]?.evaluations?.map(e => e.score)?.reduce((a, b) => a + b)}`, size: 23 })], alignment: 'center', })]
                                    }),
                                    new TableCell({
                                        verticalAlign: VerticalAlign.CENTER,
                                        width: {
                                        ...
                                        children: [new Paragraph({ children: [new TextRun({ text: `${students[1]?.evaluations?.map(e => e.score)?.reduce((a, b) => a + b)}`, size: 23 })], alignment: 'center', })]
                                    }),
                                    new TableCell({
                                        verticalAlign: VerticalAlign.CENTER,
                                        width: {
