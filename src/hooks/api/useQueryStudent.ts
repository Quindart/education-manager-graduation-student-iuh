...
export const useStudent = () => {
  ...
  const handleGetSearchStudentBasic = (keywords: string, searchField: string) => {
    return useQuery(
      [QueryStudent.getSearchStudentBasic, termId, keywords, searchField],
      () => StudentServices.getSearchStudentBasic(termId, keywords, searchField),
      {
  ...
  const handleGetExportDemonstrateStudentScore = () => {
    return useQuery(
      [QueryStudent.getExportDemonstrateStudentScore, termId],
      () => StudentServices.getDemonstrateStudentScore(termId),
      {
  ...
  const handleGetCountOfStudent = () => {
    return useQuery(
      [QueryStudent.getCountOfStudent, termId],
      () => StudentServices.getCountOfStudent(termId),
      {
        staleTime: 1000 * (60 * 10),
  ...
  const handleGetStudentsToExport = () => {
    return useQuery([QueryStudent.getStudentsToExport, termId, majorId], () =>
      StudentServices.getStudentsToExport(termId, majorId),
    );
  };
  //[DELETE]
